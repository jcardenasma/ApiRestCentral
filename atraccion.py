...
def acomodaEmbarque(respuesta):
        ...
        cntr40DC = int(respuesta['CNTR 40DC']) if 'CNTR 40DC' len(respuesta['CNTR 40DC']) > 0 in respuesta else 0
        cntr40HQ = int(respuesta['CNTR 40HQ']) if 'CNTR 40HQ' len(respuesta['CNTR 40HQ']) > 0 in respuesta else 0
        cntrLCL = int(respuesta['CNTR LCL']) if 'CNTR LCL' len(respuesta['CNTR LCL']) > 0 in respuesta else 0
